...
[![add data from NeLS](/images/user-guide/add_data_from_nels.png)](/images/user-guide/add_data_from_nels.png){:.screenshot}
...
[![NeLS browser](/images/user-guide/nels_browser.png)](/images/user-guide/nels_browser.png){:.screenshot}
...
[![Viewing a dataset](/images/user-guide/nels_dataset.png)](/images/user-guide/nels_dataset.png){:.screenshot}
...
[![NeLS data-specific buttons](/images/user-guide/nels_buttons.png)](/images/user-guide/nels_buttons.png){:.screenshot}
...
[![NeLS sample extraction and location info](/images/user-guide/nels_location_info.png)](/images/user-guide/nels_location_info.png){:.screenshot}

To complete the sample import process, click the "Review Extract Samples" button when the background task has finished.

[![NeLS sample review](/images/user-guide/nels_sample_extraction.png)](/images/user-guide/nels_sample_extraction.png){:.screenshot}
