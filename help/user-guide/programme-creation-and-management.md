...
description: Create and manage Programmes as umbrella groups for Projects, typically associated with funded research.
---
...
![Programme create menu]({{ "/images/user-guide/programme-create-menu.png" | relative_url }}){:.screenshot}
...
![Programme created]({{ "/images/user-guide/programme-created.png" | relative_url }}){:.screenshot}
...
![Programme accept or reject]({{ "/images/user-guide/programme-reject-or-accept.png" | relative_url }}){:.screenshot}
...
![Enable programmes flag]({{ "/images/user-guide/enable-programmes-flag.png" | relative_url }}){:.screenshot}
