...
[![Markdown ribbon UI](/images/user-guide/description_markdown_ribbon.png)](/images/user-guide/description_markdown_ribbon.png){:.screenshot}


## Projects
Assets can be assigned to projects in which they were created using the drop down menu.
[![add project 1](/images/user-guide/add_project_1.png)](/images/user-guide/add_project_1.png){:.screenshot}

You can remove any selected projects using the remove button.
[![add project 2](/images/user-guide/add_project_2.png)](/images/user-guide/add_project_2.png){:.screenshot}
...
[![Biological problem addressed 1](/images/user-guide/biological_problem_addressed_1.png)](/images/user-guide/biological_problem_addressed_1.png){:.screenshot}
...
[![Assay Type 1](/images/user-guide/assay_type_1.png)](/images/user-guide/assay_type_1.png){:.screenshot}
...
[![Technology Type 1](/images/user-guide/technology_type_1.png)](/images/user-guide/technology_type_1.png){:.screenshot}

## Organisms
[Assay specific]
You can select an organism from the drop down menu.

[![organism 1](/images/user-guide/organism_1.png)](/images/user-guide/organism_1.png){:.screenshot}
...
[![sharing permissions](/images/user-guide/sharing_permissions.png)](/images/user-guide/sharing_permissions.png){:.screenshot}
...
[![batch sharing publishing](/images/user-guide/bulk-permission-change/batch_sharing_publishing.png)](/images/user-guide/bulk-permission-change/batch_sharing_publishing.png){:.screenshot}
...
[![add tags 1](/images/user-guide/add_tags_1.png)](/images/user-guide/add_tags_1.png){:.screenshot}
...
[![add tags 1](/images/user-guide/add_attribution_1.png)](/images/user-guide/add_attribution_1.png){:.screenshot}
...
[![add creator](/images/user-guide/add-creator.png)](/images/user-guide/add-creator.png){:.screenshot}
...
[![add non-SEEK creator](/images/user-guide/add-non-seek-creator.png)](/images/user-guide/add-non-seek-creator.png){:.screenshot}
...
[![add publication 1](/images/user-guide/add_publication_1.png)](/images/user-guide/add_publication_1.png){:.screenshot}
...
[![add publication 2](/images/user-guide/add_publication_2.png)](/images/user-guide/add_publication_2.png){:.screenshot}
...
[![add assay 1](/images/user-guide/add_assay_1.png)](/images/user-guide/add_assay_1.png){:.screenshot}
...
[![add assay 2](/images/user-guide/add_assay_2.png)](/images/user-guide/add_assay_2.png){:.screenshot}
...
[![add event 1](/images/user-guide/add_event_1.png)](/images/user-guide/add_event_1.png){:.screenshot}
...
[![add event 2](/images/user-guide/add_event_2.png)](/images/user-guide/add_event_2.png){:.screenshot}
