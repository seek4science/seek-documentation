...
## Browsing Investigations, Studies and Assays
You can browse Investigations, Studies and Assays registered in SEEK.
* From any page, click on Browse from the top navigation bar
* Select Investigations, Studies or Assays from the dropdown menu
* Several filters allow you to quickly find relevant information, e.g.: 
  * Filter by creation/update time
  * Filter by Project 
  * Filter by ISA-JSON compliance (For Investigations or Assays)
  * Filter by Creator 
  * Filter by Submitter

## Browsing Experiment Sample Template (EST)
You can browse ESTs registered in SEEK.
* From any page, click on Browse from the top navigation bar
* Select Experimental Sample Template from the dropdown menu
* Several filters allow you to quickly find relevant information, e.g.: 
  * Filter by creation/update time
  * Filter by Project and/or Programme
  * Filter by Creator and/or Submitter
  * Filter by Experiment Sample Template group
