...
[![Request Membership Button](/images/user-guide/request-membership-button.png)](/images/user-guide/request-membership-button.png){:.screenshot}
...
[![Request Join Project](/images/user-guide/request-join-project-selected.png)](/images/user-guide/request-join-project-selected.png){:.screenshot}
...
[![Search to Join](/images/user-guide/search-to-join-project.png)](/images/user-guide/search-to-join-project.png){:.screenshot}

[![Search to Join](/images/user-guide/search-to-join-project-selected-3.png)](/images/user-guide/search-to-join-project-selected-3.png){:.screenshot}
...
[![Define Institution](/images/user-guide/create-project-define-institution.png)](/images/user-guide/create-project-define-institution.png){:.screenshot}
