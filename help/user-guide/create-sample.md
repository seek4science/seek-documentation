...
[![menu create sample](/images/user-guide/samples/menu-create-sample.png){:.screenshot}](/images/user-guide/samples/menu-create-sample.png)
...
[![select sample type](/images/user-guide/samples/select-sample-type.png){:.screenshot}](/images/user-guide/samples/select-sample-type.png)
...
[![create sample attributes](/images/user-guide/samples/create-sample-attributes.png){:.screenshot}](/images/user-guide/samples/create-sample-attributes.png)
