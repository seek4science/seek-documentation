...
Definition of terms used in {{ site.instance_name | default: "FAIRDOM-SEEK" }}.
...
#### External
The search can be extended to incude results from external online resources Linked? Integrated? with {{ site.instance_name | default: "FAIRDOM-SEEK" }}.
#### Advanced search with filtering
To access the query and the faceted navigation option for one specific item category (e.g. Documents).

### Storage Usage
Storage metrics, for Programmes and Projects, available to {{ site.instance_name | default: "FAIRDOM-SEEK" }} administrator. It provides the total size of all Programme or Project assets.
...
### Copasi
To download a public SBML format model from {{ site.instance_name | default: "FAIRDOM-SEEK" }} to a locally installed Copasi application and start the simulation in Copasi.
### JWS online
...
### OpenBIS
To fetch and register OpnBIS elements in {{ site.instance_name | default: "FAIRDOM-SEEK" }}.
### Publish in Zenodo
To publish a snapshot to Zenodo from {{ site.instance_name | default: "FAIRDOM-SEEK" }}.
<!--### Project folders
