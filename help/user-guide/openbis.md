...
description: Connect projects to openBIS spaces to enable integration with openBIS data management systems.
---
...
![admin openbis menu]({{ "/images/user-guide/openbis/admin-openbis-menu.png" | relative_url }}){:.screenshot}
