...
description: Guidelines for contributing including non-developer and developer contributions, bug fixes and new features.
redirect_from: "/contributing-to-seek.html"
---

We welcome all sorts of contributions to FAIRDOM-SEEK,

* **Non-developer contributions.** These are contributions that can be made by anyone
  using SEEK.
  * *Vote and comment other feature requests:* [Contact us](https://fair-dom.org/contact); please use the [SEEK issue tracker](https://fair-dom.org/issues).
...
Once you have finished making your changes and wish to contribute them, you can do so by issuing a pull request. Please provide a clear description of what the pull request changes and solves, and provide a reference to the related issue(s).
...
For a contribution to be accepted, we do have a few requirements.
  ...
  * Where practical, tests should be added to cover your changes, and all existing tests should pass. [Github Action](https://github.com/seek4science/seek/actions) workflows are used for continuous integration testing, and are triggered on each push and pull request. _Be pragmatic, don't spend 2 days writing tests for a 5 minute 2 line fix!_
